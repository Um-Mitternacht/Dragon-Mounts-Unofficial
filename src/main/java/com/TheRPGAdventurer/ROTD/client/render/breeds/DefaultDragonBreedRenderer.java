...
import com.TheRPGAdventurer.ROTD.client.render.LayerRendererDragonGlow;
import com.TheRPGAdventurer.ROTD.client.render.LayerRendererDragonSaddle;
...
//        layers.add(new LayerRendererDragonGlowAnim(parent, this, model));
        ...
        bodyTexture = new ResourceLocation(RealmOfTheDragons.MODID, DragonRenderer.TEX_BASE + skin + "/body.png");
        glowTexture = new ResourceLocation(RealmOfTheDragons.MODID, DragonRenderer.TEX_BASE + skin + "/glow.png");
        glowAnimTexture = new ResourceLocation(RealmOfTheDragons.MODID, DragonRenderer.TEX_BASE + skin + "/glow_anim.png");
        saddleTexture = new ResourceLocation(RealmOfTheDragons.MODID, DragonRenderer.TEX_BASE + skin + "/saddle.png");
        eggTexture = new ResourceLocation(RealmOfTheDragons.MODID, DragonRenderer.TEX_BASE + skin + "/egg.png");
        dissolveTexture = new ResourceLocation(RealmOfTheDragons.MODID, DragonRenderer.TEX_BASE + "dissolve.png");
    }
