...
import com.TheRPGAdventurer.ROTD.server.entity.ai.air.EntityAIDragonFollowOwner;
...
//            tasks.addTask(9, new EntityAIDragonFollowOwner(dragon, 1, 12, 128)); // mutex 2+1
            ...
            targetTasks.addTask(3, new EntityAINearestAttackableTarget(dragon, EntityLiving.class, 10, false, true, new Predicate<EntityLiving>(){
                public boolean apply(@Nullable EntityLiving p_apply_1_){return p_apply_1_ != null && IMob.VISIBLE_MOB_SELECTOR.apply(p_apply_1_);}
