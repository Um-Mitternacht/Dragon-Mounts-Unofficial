...
public class EntityTameableDragon extends EntityTameable {
	...
	public static final double BASE_ARMOR_TOUGHNESS = 5.0D;
	public static final float BASE_WIDTH = 2.5F;
	public static final float BASE_HEIGHT = 2.3F;
	public static final float RESISTANCE = 7.0F;
	...
	protected void applyEntityAttributes() {
		...
		getEntityAttribute(ARMOR).setBaseValue(BASE_ARMOR);
		getEntityAttribute(ARMOR_TOUGHNESS).setBaseValue(BASE_ARMOR_TOUGHNESS);
	}
...
//    }
	...
	public double getMountedYOffset() {
		return (isSitting() ? 1.7f : 2.1f) * getScale();
	}
