...
import com.Sunconure11.DragonMounts.DragonMountsSoundEvents;
...
public abstract class DragonBreed {
	...
	public SoundEvent getLivingSound() {
		if (rand.nextInt(2) == 0) {
			return DragonMountsSoundEvents.ENTITY_DRAGON_GROWL;
		} else {
			return DragonMountsSoundEvents.ENTITY_DRAGON_BREATHE;
		}
	}
	...
	public SoundEvent getDeathSound() {
		return DragonMountsSoundEvents.ENTITY_DRAGON_DEATH;
	}
	...
	public SoundEvent getStepSound() {
		return DragonMountsSoundEvents.ENTITY_DRAGON_STEP;
	}
